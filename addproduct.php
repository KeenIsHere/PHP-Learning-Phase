...
try {
    ...
    include 'helpers/connection.php'; // Make sure this comes first
...
$sql = "INSERT INTO product (product_name, price, description, category_id, image) VALUES ('$product_name', '$price', '$description', '$category_id', '$image_path')";
